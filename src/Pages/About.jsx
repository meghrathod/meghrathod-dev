                        ...
                        {posts.map((post) => (
                            ...
                            <article key={post.id} className="flex max-w-xl flex-col items-start justify-between group-card">
                                <div className="relative">
                                    <h2 className="my-5 text-2xl font-semibold leading-6 text-gray-900 group-hover:text-gray-600 dark:ext-gray-100 dark:text-gray-300 dark:group-hover:text-gray-100 ">
                                        <a href={post.href}>
                                            {post.title}
                                        </a>
                                    </h2>
